...
fn main() {
    ...
    let stage1_data_loader = ViriBinpackLoader::new(stage1_dataset_path, 32768, 8, filter());
    let stage2_data_loader = ViriBinpackLoader::new(stage2_dataset_path, 32768, 8, filter());
