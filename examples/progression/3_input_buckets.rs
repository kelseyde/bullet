...
fn main() {
    ...
    let schedule = TrainingSchedule {
        ...
        wdl_scheduler: wdl::Warmup { warmup_batches: 100, inner: wdl::LinearWDL { start: 0.2, end: 0.5 } },
    ...
    let data_loader = DirectSequentialDataLoader::new(&["/workspace/hobbes-6-to-21-shuffled.bin"]);
