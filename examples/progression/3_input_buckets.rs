...
fn main() {
    ...
    let stage1_data_loader = ViriBinpackLoader::new(stage1_dataset_path, 32768, 12, filter(0.5));
    let stage2_data_loader = ViriBinpackLoader::new(stage2_dataset_path, 32768, 12, filter(0.5));
